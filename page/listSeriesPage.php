...
<div class="container p-3 m-4 h-100" style="background-color: #FFFFFF; border-top: 5px solid #D40013; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
    ...
    <table class="table ">
        ...
        <a href="../page/editSeriesPage.php?id=' . $data ['id'] . '" onClick="return confirm ( \'Are you sure want to update this data?\')"><i style="color:green" class="fa-solid fa-pen-to-square fa-2x"></i></a>
